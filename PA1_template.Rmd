---
title: "Reproducible Research: Assignment by Mritunjay"
output: 
  html_document:
    keep_md: true
---
...
filelocation<-"C:/Users/mrityunjay1.pandey/Documents/R/Coursera_Assignment/Reproducible Research/Data/activity.csv"
activity <- read.csv(filelocation, stringsAsFactors=FALSE)
str(activity)
summary(activity)
```
...
percentage_na
```
Total number of missing values in the dataset amounts to **`r na_number` ** (which is **`r round(percentage_na*100,1)`** % of total observations).
